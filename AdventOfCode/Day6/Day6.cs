...
namespace AdventOfCode.Day6
{
    class Day6
    {
        ...
        public static void ImmediateMode(int Element)
        {
            Element.ToString().Reverse();
            var myString = Element.ToString().Substring(0, Element.ToString().Length - 2);
